...
If the amount of content is not too large, you can use Astro's dynamic routing feature to generate pages for each language dynamically from a single file.
