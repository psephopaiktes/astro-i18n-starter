...
`src/i18n.ts` 内には多言語サイトを生成する上で便利な関数をいくつか用意しています。以下のようにimportして利用できます。

```astro
---
import { LOCALES, DEFAULT_LOCALE, useTranslations, getLocalePaths } from "@/i18n";
---
```
...
https://pote-chil.com/blog/astro-i18n
### getLocalePaths()
